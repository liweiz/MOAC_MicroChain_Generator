 ...
 * @author David Chen
 * @dev 
 * Contract used to control the MicroChain.
 ...
 * @author David Chen
 * @dev 
 * Contract has basic functions to deploy the MicroChain.
 * Required by SubChainBase to control the MicroChain.
 */
...
contract SubChainProtocolBase {
    ...
    uint public bondMin;
    uint public constant PEDNING_BLOCK_DELAY = 5; // 8 minutes
...
contract SubChainBase {
    ...
    enum SCSRelayStatus {registerOpen, registerClose, createProposal, disputeProposal, approveProposal, registerAdd, regAsMonitor, regAsBackup}
